...
%files
    # 将blastn复制到容器中(v2.17.0)
    /home/ubuntu/app/bioinfo/datasplit_v3/blast/current/bin/blastn /usr/local/bin/blastn
    # 将csvtk复制到容器中(v0.37.0)
    /home/ubuntu/app/bioinfo/datasplit_v3/csvtk/current/csvtk /usr/local/bin/csvtk
    # 将本地编译好的bcl-convert复制到容器中(v4.4.6)
    /home/ubuntu/app/bioinfo/datasplit_v3/bcl-convert/current/usr/bin/bcl-convert /usr/local/bin/bcl-convert
    # 将fastp复制到容器中(v1.3.6)
    /home/ubuntu/app/bioinfo/datasplit_v3/fastp/current/fastp /usr/local/bin/fastp
    # 将seqkit复制到容器中(v2.13.0)
    /home/ubuntu/app/bioinfo/datasplit_v3/seqkit/current/seqkit /usr/local/bin/seqkit
